...
# Import enhanced calendar builder if available
try:
...
class CalendarIntelligenceExecutor(AgentExecutor):
    ...
    def __init__(self):
        ...
        # Initialize enhanced builder if available
        if USE_ENHANCED_BUILDER:
            self.builder = EnhancedCalendarBuilder()
            self.logger.info("Using EnhancedCalendarBuilder")
        else:
            self.builder = CalendarBuilder()
            self.logger.info("Using basic CalendarBuilder")
